...
%
% Decomposition Techniques ECOC + HDDT, for multi-class imbalanced data.
% This is our own extension of HDDT to multi-class imbalanced data, using the ECOC approach.
% it builds number1 of binary HDDT classifiers by combining the ECOC strategy and HDDT, see lines 26-51.
% then combines the outputs of different binary HDDT classifiers generated using the ECOC strategy,
% see lines 57-78, here, the decoding strategy for ECOC is the same as the imECOC decoding.
